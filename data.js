...
const OBJECTIVES = {
  easy: [
    ...
    { id:'e4',  icon:'🧱', name:'Muratore junior',    desc:'Piazza 20 blocchi',                             type:'placed',   target:20,   cum:true,  reward:200  },
    { id:'e5',  icon:'💣', name:'Prima bomba',        desc:'Usa una bomba',                                 type:'useBomb',  target:1,    cum:true,  reward:200  },
    // ── Livello 6-10: primi speciali ──
    { id:'e6',  icon:'⚡', name:'Fulminante',         desc:'Usa il fulmine orizzontale 2 volte',            type:'useLH',    target:2,    cum:true,  reward:250  },
    { id:'e7',  icon:'❄️', name:'Ghiacciato',         desc:'Usa il ghiaccio 2 volte',                      type:'useIce',   target:2,    cum:true,  reward:200  },
    { id:'e8',  icon:'🎯', name:'Doppio colpo',       desc:'Cancella 2 linee in un singolo piazzamento',   type:'multiLine',target:2,    reward:350  },
    { id:'e9',  icon:'🔄', name:'In ritmo',           desc:'Completa 5 turni (set di 3 forme)',             type:'turns',    target:5,    cum:true,  reward:200  },
    ...
    { id:'e11', icon:'🌱', name:'Piccolo costruttore',desc:'Piazza 50 blocchi in totale',                   type:'placed',   target:50,   cum:true,  reward:350  },
    { id:'e12', icon:'🎪', name:'Spettacolo doppio',  desc:'Cancella 8 linee in una partita',              type:'lines',    target:8,    reward:400  },
    { id:'e13', icon:'💨', name:'Fulmine rapido',     desc:'Usa il fulmine verticale 2 volte',             type:'useLV',    target:2,    cum:true,  reward:300  },
    { id:'e14', icon:'🍀', name:'Colpo di fortuna',   desc:'Fai un combo x3',                              type:'combo',    target:3,    reward:450  },
    { id:'e15', icon:'🎠', name:'Giocatore costante', desc:'Completa 10 turni',                            type:'turns',    target:10,   cum:true,  reward:350  },
    // ── Livello 16-20: sfide crescenti ──
    { id:'e16', icon:'💫', name:'Esplosivo',          desc:'Usa 3 bombe in partite diverse',               type:'useBomb',  target:3,    cum:true,  reward:400  },
    { id:'e17', icon:'🧊', name:'Gelo totale',        desc:'Usa il ghiaccio 5 volte',                      type:'useIce',   target:5,    cum:true,  reward:400  },
    ...
    { id:'e21', icon:'🏠', name:'Architetto base',    desc:'Piazza 100 blocchi in totale',                 type:'placed',   target:100,  cum:true,  reward:500  },
    { id:'e22', icon:'⚡', name:'Fulmine doppio',     desc:'Usa fulmine H e V nella stessa partita',       type:'useLH',    target:3,    cum:true,  reward:550  },
    ...
    { id:'e25', icon:'⏱️', name:'Maratoneta',         desc:'Completa 18 turni',                            type:'turns',    target:18,   cum:true,  reward:550  },
    // ── Livello 26-30: finale facile ──
    { id:'e26', icon:'💣', name:'Bombardiere',        desc:'Usa 5 bombe in totale',                        type:'useBomb',  target:5,    cum:true,  reward:600  },
    { id:'e27', icon:'❄️', name:'Re del ghiaccio jr', desc:'Usa il ghiaccio 8 volte',                     type:'useIce',   target:8,    cum:true,  reward:600  },
    ...
    { id:'e31', icon:'🚂', name:'Treno in corsa',      desc:'Completa 25 turni',                            type:'turns',    target:25,   cum:true,  reward:600  },
    { id:'e32', icon:'🌈', name:'Arcobaleno',           desc:'Cancella 15 linee in una partita',             type:'lines',    target:15,   reward:650  },
    { id:'e33', icon:'🔩', name:'Meccanico',            desc:'Piazza 150 blocchi in totale',                 type:'placed',   target:150,  cum:true,  reward:600  },
    { id:'e34', icon:'🎸', name:'Rock star',            desc:'Fai un combo x5',                              type:'combo',    target:5,    reward:750  },
    { id:'e35', icon:'🌪️', name:'Turbine',              desc:'Usa 8 bombe in totale',                        type:'useBomb',  target:8,    cum:true,  reward:700  },
    { id:'e36', icon:'🦅', name:'Aquila',               desc:'Raggiungi 7.000 punti',                        type:'score',    target:7000, reward:900  },
    { id:'e37', icon:'🧲', name:'Magnetico',            desc:'Usa il ghiaccio 12 volte',                     type:'useIce',   target:12,   cum:true,  reward:700  },
    { id:'e38', icon:'⚡', name:'Scarica elettrica',    desc:'Usa 8 fulmini in totale (H+V)',                type:'useLH',    target:8,    cum:true,  reward:750  },
    { id:'e39', icon:'🎻', name:'Virtuoso',             desc:'Cancella 4 linee in un solo piazzamento',      type:'multiLine',target:4,    reward:900  },
    { id:'e40', icon:'🧗', name:'Scalatore',            desc:'Completa 35 turni',                            type:'turns',    target:35,   cum:true,  reward:750  },
    { id:'e41', icon:'🦁', name:'Leone',                desc:'Piazza 200 blocchi in totale',                 type:'placed',   target:200,  cum:true,  reward:800  },
    ...
    { id:'e45', icon:'🏋️', name:'Peso massimo',         desc:'Usa 10 bombe in totale',                       type:'useBomb',  target:10,   cum:true,  reward:900  },
    { id:'e46', icon:'🧊', name:'Iceberg',              desc:'Usa il ghiaccio 15 volte',                     type:'useIce',   target:15,   cum:true,  reward:900  },
    { id:'e47', icon:'🌊', name:'Onda anomala',         desc:'Cancella 5 linee in un solo piazzamento',      type:'multiLine',target:5,    reward:1200 },
    { id:'e48', icon:'🦋', name:'Metamorfosi',          desc:'Piazza 300 blocchi in totale',                 type:'placed',   target:300,  cum:true,  reward:950  },
    { id:'e49', icon:'💡', name:'Illuminato',           desc:'Raggiungi 12.000 punti',                       type:'score',    target:12000,reward:1200 },
    { id:'e50', icon:'🚀', name:'Lancio orbitale',      desc:'Completa 50 turni',                            type:'turns',    target:50,   cum:true,  reward:1000 },
    { id:'e51', icon:'🐉', name:'Drago giovane',        desc:'Fai un combo x7',                              type:'combo',    target:7,    reward:1300 },
    { id:'e52', icon:'⚔️', name:'Guerriero',            desc:'Usa 12 fulmini in totale (H+V)',               type:'useLH',    target:12,   cum:true,  reward:1000 },
    { id:'e53', icon:'🏰', name:'Castello',             desc:'Piazza 400 blocchi in totale',                 type:'placed',   target:400,  cum:true,  reward:1100 },
    ...
    { id:'e56', icon:'🔮', name:'Oracolo',              desc:'Usa il ghiaccio 20 volte',                     type:'useIce',   target:20,   cum:true,  reward:1100 },
    { id:'e57', icon:'🌟', name:'Superstella',          desc:'Completa 70 turni',                            type:'turns',    target:70,   cum:true,  reward:1200 },
  ...
  medium: [
    ...
    { id:'m4',  icon:'🏗️', name:'Architetto',         desc:'Piazza 80 blocchi',                            type:'placed',   target:80,   cum:true,  reward:500  },
    ...
    { id:'m6',  icon:'🌩️', name:'Colpo verticale',    desc:'Usa il fulmine verticale 3 volte',             type:'useLV',    target:3,    cum:true,  reward:450  },
    { id:'m7',  icon:'❄️', name:'Glaciatore',         desc:'Usa il ghiaccio 4 volte',                      type:'useIce',   target:4,    cum:true,  reward:400  },
    { id:'m8',  icon:'🔷', name:'Grande piazzata',    desc:'Piazza una forma da 6+ blocchi',               type:'bigShape', target:6,    reward:400  },
    { id:'m9',  icon:'⏳', name:'Resistente',         desc:'Completa 20 turni',                            type:'turns',    target:20,   cum:true,  reward:450  },
    ...
    { id:'m13', icon:'🏋️', name:'Powerlifter',        desc:'Piazza 150 blocchi in totale',                 type:'placed',   target:150,  cum:true,  reward:700  },
    { id:'m14', icon:'🌩️', name:'Tempesta elettrica', desc:'Usa fulmine H e V 3 volte ciascuno',           type:'useLV',    target:5,    cum:true,  reward:700  },
    ...
    { id:'m17', icon:'🧊', name:'Tundra',             desc:'Usa il ghiaccio 7 volte',                      type:'useIce',   target:7,    cum:true,  reward:700  },
    { id:'m18', icon:'💣', name:'Artificiere pro',    desc:'Usa 6 bombe in totale',                        type:'useBomb',  target:6,    cum:true,  reward:750  },
    { id:'m19', icon:'⏰', name:'Ultra resistente',   desc:'Completa 35 turni',                            type:'turns',    target:35,   cum:true,  reward:800  },
    ...
    { id:'m23', icon:'🏰', name:'Fortezza',           desc:'Piazza 220 blocchi in totale',                 type:'placed',   target:220,  cum:true,  reward:900  },
    { id:'m24', icon:'🎆', name:'Fuochi dartificio',desc:'Usa 8 bombe in totale',                        type:'useBomb',  target:8,    cum:true,  reward:900  },
    { id:'m25', icon:'🌡️', name:'Zero assoluto',      desc:'Usa il ghiaccio 10 volte',                     type:'useIce',   target:10,   cum:true,  reward:850  },
    // ── Livello 26-30: finale medio ──
    { id:'m26', icon:'🎖️', name:'Veterano',           desc:'Completa 50 turni',                            type:'turns',    target:50,   cum:true,  reward:1000 },
    ...
    { id:'m29', icon:'⚡', name:'Maestro del fulmine',desc:'Usa fulmini 12 volte in totale',               type:'useLV',    target:12,   cum:true,  reward:1100 },
    { id:'m30', icon:'👑', name:'Re del medio',       desc:'Raggiungi 18.000 punti',                       type:'score',    target:18000,reward:2000 },
    // ── Livello 31-60: sfide estese ──
    { id:'m31', icon:'🚂', name:'Espresso',             desc:'Completa 60 turni',                            type:'turns',    target:60,   cum:true,  reward:1100 },
    { id:'m32', icon:'🌈', name:'Prisma',               desc:'Cancella 40 linee in una partita',             type:'lines',    target:40,   reward:1200 },
    { id:'m33', icon:'🔩', name:'Ingegnere',             desc:'Piazza 280 blocchi in totale',                 type:'placed',   target:280,  cum:true,  reward:1000 },
    { id:'m34', icon:'🎸', name:'Heavy metal',           desc:'Fai un combo x6',                              type:'combo',    target:6,    reward:1300 },
    { id:'m35', icon:'🌪️', name:'Ciclone',               desc:'Usa 10 bombe in totale',                       type:'useBomb',  target:10,   cum:true,  reward:1100 },
    { id:'m36', icon:'🦅', name:'Rapace',                desc:'Raggiungi 16.000 punti',                       type:'score',    target:16000,reward:1400 },
    { id:'m37', icon:'🧲', name:'Calamita',              desc:'Usa il ghiaccio 13 volte',                     type:'useIce',   target:13,   cum:true,  reward:1000 },
    { id:'m38', icon:'⚡', name:'Tempesta di fulmini',   desc:'Usa 15 fulmini in totale (H+V)',               type:'useLH',    target:15,   cum:true,  reward:1200 },
    { id:'m39', icon:'🎻', name:'Maestro',               desc:'Cancella 6 linee in un solo piazzamento',      type:'multiLine',target:6,    reward:1600 },
    { id:'m40', icon:'🧗', name:'Alpinista',             desc:'Completa 75 turni',                            type:'turns',    target:75,   cum:true,  reward:1300 },
    { id:'m41', icon:'🦁', name:'Re leone',              desc:'Piazza 350 blocchi in totale',                 type:'placed',   target:350,  cum:true,  reward:1200 },
    ...
    { id:'m45', icon:'🏋️', name:'Campione',              desc:'Usa 13 bombe in totale',                       type:'useBomb',  target:13,   cum:true,  reward:1300 },
    { id:'m46', icon:'🧊', name:'Polo nord',             desc:'Usa il ghiaccio 17 volte',                     type:'useIce',   target:17,   cum:true,  reward:1300 },
    { id:'m47', icon:'🌊', name:'Tsunami',               desc:'Cancella 7 linee in un solo piazzamento',      type:'multiLine',target:7,    reward:2000 },
    { id:'m48', icon:'🦋', name:'Farfalla di fuoco',     desc:'Piazza 450 blocchi in totale',                 type:'placed',   target:450,  cum:true,  reward:1500 },
    { id:'m49', icon:'💡', name:'Genio',                 desc:'Raggiungi 28.000 punti',                       type:'score',    target:28000,reward:2000 },
    { id:'m50', icon:'🚀', name:'Razzo spaziale',        desc:'Completa 100 turni',                           type:'turns',    target:100,  cum:true,  reward:1700 },
    { id:'m51', icon:'🐉', name:'Drago',                 desc:'Fai un combo x8',                              type:'combo',    target:8,    reward:2200 },
    { id:'m52', icon:'⚔️', name:'Condottiero',           desc:'Usa 20 fulmini in totale (H+V)',               type:'useLH',    target:20,   cum:true,  reward:1600 },
    { id:'m53', icon:'🏰', name:'Cittadella',            desc:'Piazza 600 blocchi in totale',                 type:'placed',   target:600,  cum:true,  reward:1800 },
    ...
    { id:'m56', icon:'🔮', name:'Veggente',              desc:'Usa il ghiaccio 22 volte',                     type:'useIce',   target:22,   cum:true,  reward:1800 },
    { id:'m57', icon:'🌟', name:'Stella cadente',        desc:'Completa 130 turni',                           type:'turns',    target:130,  cum:true,  reward:2000 },
  ...
  hard: [
    ...
    { id:'h4',  icon:'🏛️', name:'Costruttore',        desc:'Piazza 150 blocchi',                           type:'placed',   target:150,  cum:true,  reward:800  },
    ...
    { id:'h6',  icon:'⚡', name:'Doppio fulmine',     desc:'Usa 3 fulmini H e 3 V nella stessa partita',   type:'useLH',    target:3,    cum:true,  reward:700  },
    { id:'h7',  icon:'❄️', name:'Re del ghiaccio',   desc:'Usa il ghiaccio 6 volte',                      type:'useIce',   target:6,    cum:true,  reward:600  },
    { id:'h8',  icon:'🔷', name:'Forma massiccia',    desc:'Piazza una forma da 7+ blocchi',               type:'bigShape', target:7,    reward:600  },
    { id:'h9',  icon:'⌛', name:'Leggenda',           desc:'Completa 40 turni',                            type:'turns',    target:40,   cum:true,  reward:900  },
    ...
    { id:'h13', icon:'🏗️', name:'Grattacielo',        desc:'Piazza 300 blocchi in totale',                 type:'placed',   target:300,  cum:true,  reward:1200 },
    ...
    { id:'h16', icon:'🧊', name:'Permafrost',         desc:'Usa il ghiaccio 12 volte',                     type:'useIce',   target:12,   cum:true,  reward:1100 },
    { id:'h17', icon:'🌠', name:'Supernova',          desc:'Cancella 6 linee in un solo piazzamento',      type:'multiLine',target:6,    reward:1800 },
    { id:'h18', icon:'⏱️', name:'Immortale',          desc:'Completa 70 turni',                            type:'turns',    target:70,   cum:true,  reward:1500 },
    ...
    { id:'h23', icon:'🏺', name:'Monumento',          desc:'Piazza 500 blocchi in totale',                 type:'placed',   target:500,  cum:true,  reward:2000 },
    { id:'h24', icon:'💣', name:'Armageddon',         desc:'Usa 12 bombe in totale',                       type:'useBomb',  target:12,   cum:true,  reward:1800 },
    { id:'h25', icon:'❄️', name:'Era glaciale',       desc:'Usa il ghiaccio 18 volte',                     type:'useIce',   target:18,   cum:true,  reward:1800 },
    // ── Livello 26-30: finale epico ──
    { id:'h26', icon:'⚡', name:'Zeus',               desc:'Usa fulmini 20 volte in totale',               type:'useLV',    target:20,   cum:true,  reward:2000 },
    { id:'h27', icon:'🕰️', name:'Eterno',             desc:'Completa 100 turni',                           type:'turns',    target:100,  cum:true,  reward:2500 },
    ...
    { id:'h31', icon:'🚂', name:'Treno blindato',       desc:'Completa 120 turni',                           type:'turns',    target:120,  cum:true,  reward:2500 },
    { id:'h32', icon:'🌈', name:'Arcobaleno di fuoco',  desc:'Cancella 70 linee in una partita',             type:'lines',    target:70,   reward:2800 },
    { id:'h33', icon:'🔩', name:'Mastro artigiano',     desc:'Piazza 700 blocchi in totale',                 type:'placed',   target:700,  cum:true,  reward:2200 },
    { id:'h34', icon:'🎸', name:'Death metal',          desc:'Fai un combo x8',                              type:'combo',    target:8,    reward:3000 },
    { id:'h35', icon:'🌪️', name:'Uragano categoria 5',  desc:'Usa 15 bombe in totale',                       type:'useBomb',  target:15,   cum:true,  reward:2500 },
    { id:'h36', icon:'🦅', name:'Arpione',              desc:'Raggiungi 55.000 punti',                       type:'score',    target:55000,reward:3500 },
    { id:'h37', icon:'🧲', name:'Campo magnetico',      desc:'Usa il ghiaccio 20 volte',                     type:'useIce',   target:20,   cum:true,  reward:2200 },
    { id:'h38', icon:'⚡', name:'Fulmini di Zeus',      desc:'Usa 25 fulmini in totale (H+V)',               type:'useLH',    target:25,   cum:true,  reward:2800 },
    { id:'h39', icon:'🎻', name:'Virtuoso assoluto',    desc:'Cancella 8 linee in un solo piazzamento',      type:'multiLine',target:8,    reward:4000 },
    { id:'h40', icon:'🧗', name:'Everest',              desc:'Completa 150 turni',                           type:'turns',    target:150,  cum:true,  reward:3000 },
    { id:'h41', icon:'🦁', name:'Re della savana',      desc:'Piazza 1.000 blocchi in totale',               type:'placed',   target:1000, cum:true,  reward:2800 },
    ...
    { id:'h45', icon:'🏋️', name:'Ercole',               desc:'Usa 20 bombe in totale',                       type:'useBomb',  target:20,   cum:true,  reward:3200 },
    { id:'h46', icon:'🧊', name:'Era glaciale',         desc:'Usa il ghiaccio 28 volte',                     type:'useIce',   target:28,   cum:true,  reward:3000 },
    { id:'h47', icon:'🌊', name:'Fine del mondo',       desc:'Cancella 10 linee in un solo piazzamento',     type:'multiLine',target:10,   reward:6000 },
    { id:'h48', icon:'🦋', name:'Fenice',               desc:'Piazza 1.500 blocchi in totale',               type:'placed',   target:1500, cum:true,  reward:3800 },
    { id:'h49', icon:'💡', name:'Einstein',             desc:'Raggiungi 100.000 punti',                      type:'score',    target:100000,reward:5000 },
    { id:'h50', icon:'🚀', name:'Destinazione marte',   desc:'Completa 200 turni',                           type:'turns',    target:200,  cum:true,  reward:4000 },
    { id:'h51', icon:'🐉', name:'Drago antico',         desc:'Fai un combo x10',                             type:'combo',    target:10,   reward:5500 },
    { id:'h52', icon:'⚔️', name:'Esercito',             desc:'Usa 35 fulmini in totale (H+V)',               type:'useLH',    target:35,   cum:true,  reward:4000 },
    { id:'h53', icon:'🏰', name:'Impero',               desc:'Piazza 2.000 blocchi in totale',               type:'placed',   target:2000, cum:true,  reward:4500 },
    ...
    { id:'h56', icon:'🔮', name:'Il Profeta',           desc:'Usa il ghiaccio 40 volte',                     type:'useIce',   target:40,   cum:true,  reward:5000 },
    { id:'h57', icon:'🌟', name:'Galassia',             desc:'Completa 300 turni',                           type:'turns',    target:300,  cum:true,  reward:6000 },
